...
GO
CREATE procedure [dbo].[izvPregledPolisaVozila] @UserID int, @mb varchar(20)=null, @polisa bigint=null, @ponuda varchar(100)=null, @naziv varchar(20)=null, @brojsasije varchar(20)=null, @regbroj varchar(20)=null, @marka varchar(20)=null,  @StatusGrupa varchar(500)
WITH RECOMPILE  
as
