...
GO
CREATE procedure [dbo].[Napuni_dimOsiguranici] 
as  
truncate table dimOsiguranici 
 
INSERT dimOsiguranici(factPolisa,RB,Partner_ID,Naziv,RC_ICO,Drzava,PTT,Grad,Ulica,Broj,FizickoLice,Leasing,Mobilni,EMail,SMSEmailDozvoljen,Telefon,Fax) 
...
from ssis_osiguranici a inner join factPolise b on a.Poistka_ID=b.Polisa 
