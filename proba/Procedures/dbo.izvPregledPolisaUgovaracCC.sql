...
GO
CREATE procedure [dbo].[izvPregledPolisaUgovaracCC] @mb varchar(20)=null, @polisa bigint=null, @ponuda varchar(100)=null, @naziv varchar(20)=null,  @StatusGrupa varchar(500)
as
